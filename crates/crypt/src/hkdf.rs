...
mod tests {
    ...
    fn test_hkdf_hmac_sha384_2() {
        ...
        assert_eq!(
            ...
            hex!(
                "484ca052b8cc724fd1c4ec64d57b4e81
                 8c7e25a8e0f4569ed72a6a05fe0649ee
                 bf69f8d5c832856bf4e4fbc17967d549
                 75324a94987f7f41835817d8994fdbd6
                 f4c09c5500dca24a56222fea53d8967a
                 8b2e"
            )
        );
    }
        ...
        assert_eq!(
            ...
            hex!(
                "c8c96e710f89b0d7990bca68bcdec8cf
                 854062e54c73a7abc743fade9b242daac
                 c1cea5670415b52849c"
            )
        );
    }
    ...
    fn test_hkdf_hmac_sha384_4() {
        ...
        assert_eq!(
            hkdf_expand::<Sha384, 42>(&hkdf_extract::<Sha384>(&salt, &ikm), &info),
            hex!(
                "fb7e6743eb42cde96f1b70778952ab75
                 48cafe53249f7ffe1497a1635b201ff1
                 85b93e951992d858f11a"
            )
        );
    }
}
